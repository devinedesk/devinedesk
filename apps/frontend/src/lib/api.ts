...
export const deleteAccount = () => del("/api/me");
...
export const startCheckout = (packId: string) =>
  postJson<CheckoutSession>("/api/credits/checkout", { packId });
export const confirmPayment = (paymentRowId: string) =>
  postJson<{ balance: number }>("/api/credits/confirm", { paymentRowId });

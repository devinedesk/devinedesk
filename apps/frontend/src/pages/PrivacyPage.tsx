  ...
  return (
    <LegalPage title="Privacy Policy" updated="August 19, 2026">
      <p className="text-sm leading-7 text-muted-foreground">
        DevineDesk (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) is committed to
      ...
      <LegalSection heading="Information we collect">
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            ...
            (Dodo Payments). We do not store your full card details on our servers.
          </li>
          <li>
      ...
      <LegalSection heading="Third-party services">
        <p>
          ...
          (e.g. OpenRouter) to generate media, object storage to host your files, and Dodo Payments to

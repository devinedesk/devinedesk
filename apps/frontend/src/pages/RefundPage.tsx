...
export function RefundPage() {
  return (
    <LegalPage title="Refund & Cancellation Policy" updated="August 19, 2026">
      <p className="text-sm leading-7 text-muted-foreground">
        This Refund &amp; Cancellation Policy explains how purchases of credits on DevineDesk are
        handled. Please read it carefully before making a payment.
      </p>

      <LegalSection heading="Credits and digital goods">
        <p>
          DevineDesk sells prepaid <strong>credits</strong> that are consumed when you generate
      ...
      <LegalSection heading="How to request a refund">
        <p>
          ...
          Dodo Payments, typically within <strong>5&ndash;7 business days</strong>.
        </p>
      </LegalSection>

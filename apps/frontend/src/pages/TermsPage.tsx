  ...
  return (
    <LegalPage title="Terms of Service" updated="August 19, 2026">
      <p className="text-sm leading-7 text-muted-foreground">
        These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and use of DevineDesk.
        By creating an account or using the service, you agree to these Terms.
      </p>

      <LegalSection heading="Eligibility & accounts">
        <p>
          You must be at least 18 years old to use DevineDesk. You are responsible for keeping your
      ...
      <LegalSection heading="Credits & payments">
        <p>
          Paid features are accessed using prepaid credits purchased through Dodo Payments. All purchases
          are subject to our{" "}
      ...
      <LegalSection heading="Disclaimer & liability">
        <p>
          ...
          extent permitted by law, DevineDesk is not liable for any indirect or consequential

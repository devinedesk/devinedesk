...
const translations = {
    en: {
        ...
        'auth.subtitle': 'Create a Platform access key, then paste the key value here to start creating high-aesthetic images.',
        'auth.keyLabel': 'Platform Access Key',
        'auth.keyPlaceholder': 'Paste your access key value...',
        'auth.keyNote': 'Do not enter the key name or label; paste the generated key value from Platform.',
        ...
        'mcp.title': 'MCP & CLI',
        'mcp.subtitle': 'Use devinedesk from your terminal, your IDE, or any MCP-compatible assistant. Generate cinematic images, videos, and audio across 100+ models — without leaving your workflow.',
    ...
    zh: {
        ...
        'mcp.title': 'MCP & CLI',
        'mcp.subtitle': '在终端、IDE 或任何兼容 MCP 的助手中使用 devinedesk。跨 100+ 模型生成电影级图像、视频和音频 — 无需离开您的工作流。',
        'mcp.quickStart': '快速开始',
    },
};

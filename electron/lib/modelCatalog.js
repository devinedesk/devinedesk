...
const LOCAL_MODEL_CATALOG = [
  ...
  // Requires auxiliary files: Qwen3-4B LLM text encoder + FLUX VAE
  {
    ...
    name: 'Z-Image Turbo',
    description:
      "WaveSpeed's featured local model — ultra-fast 8-step generation. No API key needed. Requires text encoder + VAE (~2.7 GB extra).",
    type: 'z-image',
  ...
  },
  {
    ...
    name: 'Z-Image Base',
    description:
      'Full-quality model from Tongyi-MAI — higher detail, 50-step generation. Requires text encoder + VAE (~2.7 GB extra).',
    type: 'z-image',
  ...
  },
  {
    ...
    sizeGB: 2.1,
    downloadUrl:
      'https://huggingface.co/Yntec/AnythingV5/resolve/main/Anything-v5.0-PRT.safetensors',
    aspectRatios: ['1:1', '4:3', '3:4', '16:9', '9:16'],
    defaultWidth: 512,
    defaultHeight: 768,
    defaultSteps: 20,

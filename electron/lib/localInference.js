...
function fetchJson(url) {
    return new Promise((resolve, reject) => {
        https.get(url, { headers: { 'User-Agent': 'devinedesk' } }, (res) => {
...
const CUSTOM_BINARIES = {
    'darwin-arm64': 'https://github.com/devinedesk/devinedesk/releases/download/v1.0.3-binaries/sd-cli-metal-macos-arm64.zip',
};

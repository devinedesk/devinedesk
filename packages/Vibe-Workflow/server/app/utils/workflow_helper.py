...
async def get_api_key():
    ...
    if not api_key:
        raise HTTPException(status_code=400, detail="Setup LOCAL_API_KEY in .env to be able to use Workflow")
    return api_key

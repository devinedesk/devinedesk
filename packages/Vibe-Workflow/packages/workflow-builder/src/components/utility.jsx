    ...
    input_params: {
      properties: {
        videos_list: {
          ...
          description:
            'Upload the video clips you want to combine, in order. Each clip can be 5–60 seconds.',
          field: 'videos_list',
          type: 'array',
          items: {
            type: 'string',
        ...
        aspect_ratio: {
          ...
          default: 'auto',
          description:
            "Output aspect ratio. 'auto' uses the aspect ratio of the first uploaded clip.",
        },
      },
...
export const presets = [
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          resultUrl: 'https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=800&q=80',
        },
        type: 'imageNode',
      },
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          formValues: {
            prompt:
              'Wide cinematic shot of a glowing futuristic city built from floating geometric shapes and holographic panels. Neon blue and purple lights, soft volumetric fog, reflective surfaces, dramatic sky, ultra-realistic lighting, depth of field, 8K detail, sci-fi cinematic style, symmetrical composition.',
            aspect_ratio: '1:1',
            quality: 'high',
          },
          outputs: [
  ...
  },
  {
    ...
    icon: 'audio',
    image:
      'https://images.unsplash.com/photo-1526512340740-9217d0159da9?q=80&w=500&auto=format&fit=crop',
    nodes: [
      {
        id: 'text1',
        position: { x: -9, y: 30 },
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          formValues: {
            prompt:
              'Provide a detailed prompt of this image, capturing as many elements as possible. Include specifics about the colors, textures, any people or objects present, and the setting. Describe the atmosphere, any notable features or interactions, and the overall mood of the scene.',
            image_url: 'https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=800&q=80',
          },
          outputs: [
            {

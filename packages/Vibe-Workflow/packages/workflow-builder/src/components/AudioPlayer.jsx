...
const AudioPlayer = ({ src, className }) => {
  ...
  return (
    <div
      className={
        className ||
        'flex flex-col items-center justify-center p-4 w-full h-full bg-gradient-to-br from-[#121418] to-[#08090a] rounded-xl border border-white/5 relative group transition-all duration-500 select-none'
      }
    >
        ...
        {bars.map((height, i) => (
          <div
            ...
            style={{
              ...
              boxShadow:
                i / bars.length < progress / 100 ? '0 0 10px rgba(59, 130, 246, 0.4)' : 'none',

    ...
    <div className="bg-[#111]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-5 flex flex-col gap-4">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1">
          <h4 className="text-xs font-bold text-[#888] uppercase tracking-wider mb-3">Quick Starters</h4>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            {QUICK_PROMPTS.map(q => (
              <button
                ...
                className="px-3 py-2 rounded-lg text-xs font-bold bg-white/5 text-[#888] hover:bg-white/10 hover:text-[#22d3ee] transition-all text-left border border-white/5 hover:border-[#22d3ee]/30"
              >
                {q.label}
              </button>
            ))}
        ...
        <div className="flex-1">
          <h4 className="text-xs font-bold text-[#888] uppercase tracking-wider mb-3">Prompt Enhancer</h4>
          <div className="flex flex-col gap-3">
            ...
            <div>
              <label className="text-[10px] font-bold text-[#555] uppercase tracking-wider mb-2 block">Enhancement Tags</label>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[10px] font-bold text-[#555] uppercase tracking-wider">Enhanced Prompt</label>
              <div className={`w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-xs min-h-[40px] ${enhancedText ? 'text-white' : 'text-[#555]'}`}>
              ...
              <div className="flex gap-2">
                ...
                <button 
                  onClick={handleUse}
                  className="px-3 py-1.5 rounded-lg text-xs font-bold bg-[#22d3ee] text-black hover:shadow-[0_0_15px_rgba(34,211,238,0.3)] transition-all"
                >
                  Use in Generator
                </button>
              </div>

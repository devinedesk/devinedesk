...
function WorkflowCard({ workflow, onClick, activeTab, onRename, onDelete }) {
  ...
  return (
    <div
      ...
      className="group relative aspect-[3/4] rounded-lg overflow-hidden cursor-pointer border border-white/5 bg-panel-bg transition-all hover:border-primary/30 hover:scale-[1.02] shadow-2xl"
    >
      {workflow.thumbnail ? (
        <img
    ...
    if (urlWorkflowId) {
      if (urlWorkflowId === 'new') {
        ...
        if (found) {
          ...
          handleSelectWorkflow({ id: urlWorkflowId, name: 'Loading...' }, true);
        }
      }
          ...
          <div className="absolute top-4 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-4 px-4 py-2 bg-black/60 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl animate-fade-in-down">
            ...
            <div className="flex bg-white/5 p-1 rounded-lg">
              <button
                ...
                className={`px-3 py-1 text-[9px] font-black uppercase tracking-widest rounded-md transition-all ${
                  activeSubTab === 'playground' ? 'bg-primary text-black' : 'text-white/60'
                }`}
              >
                Play
              </button>
              <button
                ...
                type="button"
                className={`px-3 py-1 text-[9px] font-black uppercase tracking-widest rounded-md transition-all ${
                  activeSubTab === 'builder' ? 'bg-primary text-black' : 'text-white/60'
                }`}
              >
                Builder
              </button>
            ...
            >
              <svg
                ...
                strokeWidth="3"
              >
                <path d="M4 14h6v6M20 10h-6V4M10 20l-7-7M14 4l7 7" />
              </svg>
              Exit Zen
            </button>
          </div>
              ...
              <div className="w-full lg:w-[400px] border-r border-white/5 flex flex-col bg-black/20">
                <div className="p-6 overflow-y-auto flex-1 custom-scrollbar">
                  <form onSubmit={handleRun} className="space-y-6">
                    <div>
                      <h3 className="text-xs font-black text-white/60 uppercase tracking-widest mb-4">
                        Configuration
                      </h3>
              ...
              <div className="flex-1 overflow-y-auto p-8 lg:p-12 bg-[#050505] flex items-center justify-center min-h-[500px]">
                ...
                {!isExecuting && !result && !error && (
                  <div className="flex flex-col items-center gap-6 opacity-40">
                    <div className="w-20 h-20 bg-white/5 rounded-3xl flex items-center justify-center text-white/60">
                      <svg
                        width="40"
                        height="40"
                        viewBox="0 0 24 24"
                    ...
                    <p className="text-xs text-white/60 max-w-[200px] mx-auto text-center font-medium">
                ...
                {isExecuting && (
                  <div className="flex flex-col items-center gap-6 animate-fade-in">
                    <div className="relative">
                      <div className="w-24 h-24 border-[3px] border-white/5 border-t-primary rounded-full animate-spin shadow-[0_0_40px_rgba(34, 211, 238,0.1)]" />
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col gap-6 mb-12">
          <div className="flex items-end justify-between">
            <div>
              <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">Workflows</h1>
      ...
      {renamingWorkflow && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          <form
            ...
            className="relative w-full max-w-sm bg-panel-bg border border-white/10 rounded-2xl p-8 shadow-2xl animate-in fade-in zoom-in duration-300"
          >
            <h3 className="text-xl font-bold text-white mb-2">Rename Workflow</h3>
            <p className="text-white/60 text-sm mb-6">
              Enter a new descriptive name for your pipeline.
            </p>

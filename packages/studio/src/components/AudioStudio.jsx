    ...
    <div className="w-full bg-zinc-900 border border-zinc-700/80 rounded p-6 shadow-3xl space-y-6 backdrop-blur-md">
      ...
      <div className="flex flex-col items-center justify-center py-6 relative rounded bg-black/60 overflow-hidden border border-zinc-800">
        ...
        <div className="text-center px-4 max-w-full relative z-10">
          ...
          <p className="text-white font-bold text-base truncate max-w-xs">
...
export default function AudioStudio({
  ...
  useStudioPersistedState(
    ...
    },
    {
      ...
      activeResultUrl: setActiveResultUrl,
      activeResultTitle: setActiveResultTitle,
      view: setView,
    }
  );
                ...
                if (schema.type === 'boolean') {
                  return (
                    ...
                    >
                      ...
                      >
                        <div
                          className={`w-4 h-4 rounded-full bg-black shadow-md transform transition-all duration-300 ${
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-[10px] text-zinc-300 font-medium w-6 text-right">
                          {schema.minValue}
                        </span>
                        <input
                          type="range"
                        ...
                        />
                        <span className="text-[10px] text-zinc-300 font-medium w-6 text-left">
                          {schema.maxValue}
                        </span>
                      </div>
                      {schema.description && (
          ...
          {generateError && (
            <div className="w-full max-w-md mx-auto mb-8 p-6 bg-red-500/10 border border-red-500/20 rounded flex flex-col items-center gap-4 animate-shake">
              ...
              <div className="text-center">
                ...
                <p className="text-white font-medium text-sm leading-relaxed">{generateError}</p>
              </div>
            </div>
          )}
          ...
          {!isGenerating && history.length > 0 && (
            <div className="w-full pt-6 border-t border-white/5">
              <StudioGallery
                ...
                onDelete={(entry) =>
                  setInternalHistory((prev) => prev.filter((h) => h.id !== entry.id))
                }

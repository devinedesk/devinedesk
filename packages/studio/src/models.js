  ...
  },
  {
    ...
    inputs: {
      ...
      image_url: {
        examples: [],
        description:
          'Optional reference image URL. Influences the style and content of the generation.',
        field: 'image',
        type: 'string',
      ...
      aspect_ratio: {
        enum: ['1:1', '16:9', '9:16', '3:4', '4:3', '21:9'],
        type: 'string',
        title: 'Aspect Ratio',
        name: 'aspect_ratio',
      ...
      stylize: {
        ...
        name: 'stylize',
        description:
          'Controls how artistic the result is. Range: 0–1000. Lower = more literal, higher = more stylized.',
        default: 100,
        minValue: 0,
        maxValue: 1000,
        step: 10,
      ...
      chaos: {
        ...
        name: 'chaos',
        description:
          'Controls variation between the 4 images. Range: 0–100. Higher = more diverse.',
        default: 0,
        minValue: 0,
        maxValue: 100,
        step: 1,
      ...
      negative_prompt: {
        ...
        examples: ['text, watermark, blurry'],
      },
      seed: {
        type: 'int',
        title: 'Seed',
        name: 'seed',
        description:
          'Reproducibility seed. Range: 0–4294967295. Same seed + same prompt ≈ similar result.',
        default: 0,
        minValue: 0,
        maxValue: 4294967295,
        step: 1,
...
export const t2vModels = [
  ...
  },
  {
    ...
    inputs: {
      ...
      prompt: {
        ...
        name: 'prompt',
        description:
          "Optional prompt to guide the extension. Reference images with @image2…@image9, videos with @video1…@video3 (the source video's last frame is always @image1).",
      },
      images_list: {
        type: 'array',
        ...
        name: 'images_list',
        description:
          'Up to 8 additional reference image URLs. Each Nth image maps to @image(N+1) in the prompt.',
        maxItems: 8,
      },
      video_files: {
        type: 'array',
        ...
        name: 'video_files',
        description:
          'Up to 3 reference video clip URLs (MP4, max 15s each). Each Nth video maps to @videoN in the prompt.',
        maxItems: 3,
      },
      duration: {
        enum: [5, 10, 15],
  ...
  },
  {
    ...
    inputs: {
      request_id: {
        examples: [''],
        description:
          'Request ID of the original video generation. Must be a valid Id returned from the video generation interface.',
        format: 'text',
        type: 'string',
        title: 'Request Id',
        name: 'request_id',
  ...
  },
  {
    ...
    inputs: {
      request_id: {
        examples: ['cab9517f-1818-4910-8d66-292701c78c2d'],
        description: 'Request ID of the original Seedance 2.0 video generation.',
        format: 'text',
        type: 'string',
        title: 'Request Id',
  ...
  },
  {
    ...
    inputs: {
      request_id: {
        examples: [''],
        description:
          'Request ID of the original video generation. Must be a valid ID returned from a previous Grok Imagine video generation.',
        format: 'text',
        type: 'string',
        title: 'Request Id',
        name: 'request_id',
...
export const i2iModels = [
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        examples: ['Add a tiny blue knitted scarf around the kitten’s neck.'],
        description:
          'Text prompt describing the image, what you want the final edited image to look like.',
        type: 'string',
        title: 'Prompt',
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        examples: ['Add a small red bow tie around the puppy’s neck.'],
        description:
          'Text prompt describing the image, what you want the final edited image to look like.',
        type: 'string',
        title: 'Prompt',
  ...
  },
  {
    ...
    inputs: {
      image_url: {
        ...
        field: 'image',
        examples: ['https://cdn.api.ai/outputs/d09a771a8b2a45f1b0b5e6aba5955f1b.jpg'],
      },
      name: {
        type: 'string',
        title: 'Name',
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        examples: ['A red leather jacket with black jeans and white sneakers'],
      },
      images_list: {
        examples: [
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        description:
          'Text instructions describing the desired transformation. Maximum 2,000 characters.',
        type: 'string',
        title: 'Prompt',
        name: 'prompt',
      },
  ...
  },
  {
    ...
    inputs: {
      ...
      images_list: {
        examples: ['https://cdn.api.ai/assets/nano-banana-2-lite-edit-in.jpg'],
...
export const i2vModels = [
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        name: 'prompt',
        description:
          'Text prompt. Reference uploads via @image_file_1, @video_file_1, @audio_file_1, etc.',
        examples: [
      ...
      images_list: {
        ...
        description:
          'Up to 9 reference image URLs. Each Nth image corresponds to @image_file_N in the prompt.',
        field: 'images_list',
        type: 'array',
        items: {
          type: 'string',
      ...
      video_files: {
        ...
        description:
          'Up to 3 reference video clip URLs. Each Nth video corresponds to @video_file_N in the prompt.',
        field: 'videos_list',
        type: 'array',
        items: {
          type: 'string',
      ...
      audio_files: {
        ...
        description:
          'Up to 3 reference audio clip URLs. Each Nth audio corresponds to @audio_file_N in the prompt.',
        field: 'audios_list',
        type: 'array',
        items: {
          type: 'string',
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        examples: ['A smooth cinematic transition between two scenes.'],
      },
      images_list: {
        examples: [
          'https://d3adwkbyhxyrtq.cloudfront.net/ai-images/186/712345784292/4a8c5c70-abcc-4920-873e-b0e219986453.jpg',
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        examples: ['A person walking in the rain...'],
      },
      images_list: {
        examples: [],
  ...
  },
  {
    ...
    inputs: {
      ...
      images_list: {
        ...
        description:
          'Upload up to 9 image URLs. Reference them in the prompt using @image1, @image2, … @image9.',
        field: 'images_list',
        type: 'array',
        items: {
          type: 'string',
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        examples: ['The person walks forward with a smile.'],
      },
      images_list: {
        examples: [
          'https://d3adwkbyhxyrtq.cloudfront.net/ai-images/186/712345784292/4a8c5c70-abcc-4920-873e-b0e219986453.jpg',
        ...
        description:
          '1 image uses it as the start frame (first_last_frames mode). 2–9 images switches to omni_reference mode — reference them in your prompt with @image1, @image2, etc.',
        field: 'images_list',
        type: 'array',
        items: {
          type: 'string',
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        examples: ['Two people having a street interview, the interviewer holds a microphone.'],
      },
      images_list: {
        examples: [
          'https://d3adwkbyhxyrtq.cloudfront.net/ai-images/186/712345784292/4a8c5c70-abcc-4920-873e-b0e219986453.jpg',
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        name: 'prompt',
        description:
          'Text description guiding the video animation. Use @character:<id> to reference a completed Seedance 2 Character generation. Use @omni-character:<char_id> for a trained Kinovi character.',
        examples: ['The person walks forward with a smile.'],
      },
      images_list: {
        examples: [
  ...
  },
  {
    ...
    inputs: {
      ...
      prompt: {
        ...
        examples: ['Camera slowly pans left, parallax depth, cinematic lighting.'],
      },
      aspect_ratio: {
        enum: ['16:9', '9:16', '1:1'],
        type: 'string',
  ...
  },
  {
    ...
    inputs: {
      ...
      prompt: {
        ...
        examples: ['Slow cinematic pan, dramatic lighting shift.'],
      },
      aspect_ratio: {
        enum: ['21:9', '16:9', '4:3', '1:1', '3:4', '9:16'],
        type: 'string',
  ...
  },
  {
    ...
    inputs: {
      ...
      aspect_ratio: {
        ...
        type: 'string',
        description:
          'Aspect ratio of the output video. Match this to your source image to avoid cropping.',
        default: '16:9',
      },
      duration: {
        title: 'Duration',
  ...
  },
  {
    ...
    inputs: {
      ...
      image_urls: {
        ...
        examples: ['https://cdn.api.ai/assets/gemini-omni-image-to-video.jpg'],
        maxItems: 7,
      },
      duration: {
        enum: [4, 6, 8, 10],
  ...
  },
  {
    ...
    inputs: {
      ...
      images_list: {
        examples: ['https://cdn.api.ai/assets/grok-imagine-video-1-5-preview.jpg'],
  ...
  },
  {
    ...
    inputs: {
      ...
      image_url: {
        ...
        description: 'URL of the input image used to generate video.',
        field: 'image',
        examples: ['https://cdn.api.ai/assets/kling-v3-turbo-standard-image-to-video.jpg'],
      },
      duration: {
        type: 'int',
        title: 'Duration',
  ...
  },
  {
    ...
    inputs: {
      ...
      image_url: {
        ...
        description: 'URL of the input image used to generate video.',
        field: 'image',
        examples: ['https://cdn.api.ai/assets/kling-v3-turbo-pro-image-to-video.jpg'],
      },
      duration: {
        type: 'int',
        title: 'Duration',
  ...
  },
  {
    ...
    inputs: {
      ...
      image_url: {
        examples: ['https://samplelib.com/jpeg/sample-city-park-400x300.jpg'],
        description: 'URL of the input image to animate into video.',
        field: 'image',
        type: 'string',
        title: 'Image URL',
...
export const v2vModels = [
  ...
  },
  {
    ...
    hasPrompt: true,
    description:
      'Transform any input video into a new visual style or scene while preserving motion and structure.',
    provider: 'runway',
    provider_name: 'RunwayML',
  },
  {
    ...
    hasPrompt: true,
    description:
      'Luma Modify Video lets you transform an existing video into a new creative scene while keeping the original motion and timing intact.',
    provider: 'luma',
  ...
  },
  {
    ...
    hasPrompt: true,
    description:
      'Bring your characters and worlds to life with AI Dance Effects — a creative video effect that adds playful, dynamic, and cinematic motion to your generations.',
    provider: 'Local API',
    provider_name: 'Local API',
  },
  {
    ...
    hasPrompt: false,
    description:
      'The AI Video Upscaler is a powerful tool designed to enhance the resolution and quality of videos.',
    provider: 'Local API',
    provider_name: 'Local API',
  },
  {
  ...
  },
  {
    ...
    hasPrompt: false,
    description:
      'Convert any video into 175+ languages with synchronized voice translation, AI-voice cloning, and accurate lip sync.',
    provider: 'Local API',
    provider_name: 'Local API',
  },
  {
  ...
  },
  {
    ...
    hasPrompt: true,
    description:
      'Kling O1 Video Edit lets you send an existing video clip plus an instruction/prompt to edit or transform the clip while preserving temporal coherence and subject identity.',
    provider: 'kling',
    provider_name: 'Kling AI',
  },
  {
  ...
  },
  {
    ...
    hasPrompt: true,
    description:
      'Kling O1 Standard Video-to-Video Edit modifies an existing video while preserving its original structure, motion, and realism.',
    provider: 'kling',
    provider_name: 'Kling AI',
  },
  {
  ...
  },
  {
    ...
    hasPrompt: true,
    description:
      'Seedance v1.5 Pro Video Extend continues an existing video by generating additional frames that match the original scene’s style, lighting, motion, and mood.',
    provider: 'bytedance',
    provider_name: 'ByteDance',
  },
  {
    ...
    hasPrompt: true,
    description:
      'Seedance v1.5 Pro Video Extend Fast quickly extends an existing video by generating a short continuation that matches the original style, motion, and lighting.',
    provider: 'bytedance',
    provider_name: 'ByteDance',
  },
  {
  ...
  },
  {
    ...
    hasPrompt: false,
    description:
      '🎉 FREE for a limited time — Remove SD 2.0 watermarks from videos using LaMa AI inpainting.',
    provider: 'bytedance',
    provider_name: 'ByteDance',
  },
  {
  ...
  },
  {
    ...
    hasPrompt: false,
    description:
      'SD 2 Video Watermark Remover Pro uses the SD 2 AI model to remove watermarks, logos, and overlaid text from videos with high accuracy.',
    provider: 'bytedance',
    provider_name: 'ByteDance',
  },
  {
  ...
  },
  {
    ...
    hasPrompt: false,
    description:
      'Video Background Remover automatically removes the background from any video, producing a clean cutout of the subject with a transparent or solid-color backdrop.',
    provider: 'Local API',
    provider_name: 'Local API',
  },
  {
...
export const lipsyncModels = [
  ...
  },
  {
    ...
    hasPrompt: true,
    description:
      'Kling AI Avatar Standard creates talking avatar videos from a single image + audio input.',
  },
  {
  ...
  },
  {
    ...
    hasPrompt: true,
    description:
      'AI-Avatar v2 Standard generates a talking-avatar video from a reference image and an audio dialogue.',
  },
  {
    ...
    hasPrompt: true,
    description:
      'AI-Avatar v2 Pro takes a reference image of a person/character and an audio dialogue clip, then generates a realistic talking-avatar video.',
  },
  {
    id: 'omnihuman-1-5',
    name: 'Omnihuman 1 5',
...
export const recastModels = [
  ...
  },
  {
    ...
    hasPrompt: true,
    description:
      'Wan2.2 Animate is a video-to-video model for animating a character or replacing a character in existing video clips.',
  },
];
...
export const audioModels = [
  ...
  },
  {
    ...
    inputs: {
      ...
      voice_id: {
        ...
        description:
          'Desired voice ID. Use a voice ID you have trained (https://api.ai/playground/minimax-voice-clone), or one of the following system voice IDs',
        type: 'string',
        typing: true,
        title: 'Voice ID',
        name: 'voice_id',
  ...
  },
  {
    ...
    family: 'suno',
    description:
      'Converts an existing Suno-generated music track to high-quality, uncompressed WAV format for professional editing and processing.',
    required: ['task_id', 'audio_id'],
    inputs: {
      task_id: {
        examples: ['5c79b5b3-1234-4a12-9f10-abcdef8be8e'],
        description:
      ...
      audio_id: {
        examples: ['e231e123-4567-89ab-cdef-0123456789ab'],
        description:
  ...
  },
  {
    ...
    family: 'gemini-tts',
    description:
      'Gemini 3.1 Flash TTS turns written dialogue into expressive, natural multi-speaker speech with fine-grained control over voice, accent, emotional style, and pace.',
    required: ['speakers', 'dialogue_turns'],
    inputs: {
      speakers: {
        type: 'array',
        title: 'Speakers',
        ...
        items: {
          ...
          properties: {
            ...
            audio_profile: {
              ...
              title: 'Audio Profile',
              description:
                'Optional natural-language description of the persona, e.g. "A warm and soothing narrator".',
            },
            accent: {
              type: 'string',
              title: 'Accent',
            ...
            style: {
              ...
              enum: ['Vocal Smile', 'Newscaster', 'Whisper', 'Empathetic', 'Promo/Hype', 'Deadpan'],
              default: 'Empathetic',
            },
            pace: {
              type: 'string',
          ...
          required: ['speaker_id', 'voice_name', 'accent', 'style', 'pace'],
        },
      },
      dialogue_turns: {
        type: 'array',
